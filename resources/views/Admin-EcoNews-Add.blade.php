      ...
      <main class="main-content bgc-grey-100">
        <div id="mainContent">
          <div class="container-fluid p-0">
            <h1 class="h3 mb-3"><strong>Add News</strong></h1>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <!-- Image Section -->
                      <div class="col-md-6">
                        <form action="{{ route('admin.econews.store') }}" method="POST" enctype="multipart/form-data">
                          @csrf
                          <div class="mb-3">
                          ...
                          <div class="image-box mb-3" style="text-align: center;">
                            <img id="imagePreview" src="{{ asset('img/default-image.jpg') }}" 
